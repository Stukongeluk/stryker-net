...
namespace Stryker.Core.UnitTest
{
    public class StrykerOptionsTests
    {
        ...
        {
            var options = new StrykerOptions("c:/test", "Console", "", 0, argValue, false, 60 ,70 ,80);
        ...
        public void Constructor_WithIncorrectLoglevelArgument_ShouldThrowValidationException()
        {
            ...
            Func<StrykerOptions> createOptions = () => new StrykerOptions("c:/test", "Console", "", 0, logLevel, false, 60 ,70 ,80);
