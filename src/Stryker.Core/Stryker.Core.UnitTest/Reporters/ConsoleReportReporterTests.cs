...
namespace Stryker.Core.UnitTest.Reporters
{
    public class ConsoleReportReporterTests
    {
        ...
        public void ConsoleDotReporter_ShouldPrintOnReportDone()
        {
            ...
            var target = new ConsoleReportReporter(new StrykerOptions("", "ReportOnly", "", 1000, "debug", false, 60, 70, 80), chalkMock.Object);
...
");
        ...
        public void ConsoleDotReporter_ShouldPrintRedOn60PercentAndLower()
        {
            ...
            var target = new ConsoleReportReporter(new StrykerOptions("", "ReportOnly", "", 1000, "info", false, 60, 70, 80), chalkMock.Object);
